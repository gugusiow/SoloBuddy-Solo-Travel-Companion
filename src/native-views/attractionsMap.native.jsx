...
export function AttractionsMap({ attractions }) {
  ...
  return (
    <View style={[styles.map, styles.messageContainer]}>
      <Text style={styles.title}>Map temporarily disabled in Expo Go</Text>
      <Text style={styles.messageText}>
        The rest of the mobile app should still work.
      </Text>
      <Text style={styles.messageText}>
        Attractions with coordinates: {mappableAttractions.length}
      </Text>
    </View>
  );
}
